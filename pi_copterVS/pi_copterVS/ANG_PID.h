...
public:
	...
	void set_max_output(const float a) { max_output2 = a*a; }
	float get_max_output() { return sqrt(max_output2); }
	...
	float	kP() { return _kp; }
	void    auto_reset_i_dif(const float ang) { auto_reset_v2 = ang*ang; };
