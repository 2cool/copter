...
# 6 "C:\\projects\\copter_stm32\\sketches\\copter_stm32.ino" 2
# 7 "C:\\projects\\copter_stm32\\sketches\\copter_stm32.ino" 2
...
bool ring_was = 0x0;
# 80 "C:\\projects\\copter_stm32\\sketches\\copter_stm32.ino"
...
void throttle_0(const float n) {
 pwmWrite(M0, 32112 + (uint16_t)(n*32112));
}
void throttle_1(const float n) {
 pwmWrite(M1, 32112 + (uint16_t)(n*32112));
}

void throttle_2(const float n) {
 pwmWrite(M2, 32112 + (uint16_t)(n*32112));
}
void throttle_3(const float n) {
 pwmWrite(M3, 32112 + (uint16_t)(n*32112));
}
 ...
 case 0:
  {
   ...
   if (len == 0) {
    pwmWrite(M0, ((temp)<(32112)?(32112):((temp)>(64224)?(64224):(temp))));
    bool pow_on = temp > 32112;
    temp = *((uint16_t*)&inBuf[3]);
    pow_on |= temp > 32112;
    pwmWrite(M1, ((temp)<(32112)?(32112):((temp)>(64224)?(64224):(temp))));
    temp = *((uint16_t*)&inBuf[5]);
    pow_on |= temp > 32112;
    pwmWrite(M2, ((temp)<(32112)?(32112):((temp)>(64224)?(64224):(temp))));
    temp = *((uint16_t*)&inBuf[7]);
    pow_on |= temp > 32112;
    pwmWrite(M3, ((temp)<(32112)?(32112):((temp)>(64224)?(64224):(temp))));
   }
   else {
    pwmWrite(G_PITCH, ((temp)<(32112)?(32112):((temp)>(64224)?(64224):(temp))));
    temp = *((uint16_t*)&inBuf[3]);
    pwmWrite(G_ROLL, ((temp)<(32112)?(32112):((temp)>(64224)?(64224):(temp))));
...
void setup()
{
 ...
 stop_motors();
# 362 "C:\\projects\\copter_stm32\\sketches\\copter_stm32.ino"
 //---------------------------------------------------------------
 ...
 do {
  ...
  pwmWrite(M0, MT[0] = (esc_calibr[0] && now < t + 1000 * (long)esc_calibr[0]) ? 64224 : 32112);
  pwmWrite(M1, MT[1] = (esc_calibr[1] && now < t + 1000 * (long)esc_calibr[1]) ? 64224 : 32112);
  pwmWrite(M2, MT[2] = (esc_calibr[2] && now < t + 1000 * (long)esc_calibr[2]) ? 64224 : 32112);
  pwmWrite(M3, MT[3] = (esc_calibr[3] && now < t + 1000 * (long)esc_calibr[3]) ? 64224 : 32112);
  ;
  ;
  ;
  ;
  delay(1000);
 } while (MT[0] != 32112 || MT[1] != 32112 || MT[2] != 32112 || MT[3] != 32112);
...
/*
	...
	*/
# 537 "C:\\projects\\copter_stm32\\sketches\\copter_stm32.ino"
 //------------------------------------------------------------------------------------------------------------------------------
